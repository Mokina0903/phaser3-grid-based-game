...
var GridBody = function () {
    ...
    _createClass(GridBody, [{
        ...
        /*renderDebugBody() {
            ...
            src.debug.geom(this.debugBody, 'rgba(0,255,0,0.4)');
        }*/
        ...
        */
        ...
        /* moveToXY(x, y, speed = 60, maxTime = 0, active = true) {
             ...
             let i = 0;
             let tileRatio = {
                 x: this.physics.tilemaplayers[0].layer.data[0][0].width / src.physics.gridPhysics.gridSize.x,
                 y: this.physics.tilemaplayers[0].layer.data[0][0].height / src.physics.gridPhysics.gridSize.y
             };
...
var World = function () {
    ...
    _createClass(World, [{
        ...
        value: function update(time, delta) {
            this.turnMade = false;
            var elapsedTime = delta / 1000; //body.src.time.physicsElapsed
